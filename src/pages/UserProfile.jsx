        ...
        <div className="profile__details">
          <div className="avatar__wrapper">
            ...
            <form className="form profile__form" onSubmit={ updateUserDetail } >
              ...
              <input type="password" placeholder='Current Password' value={ currentPassword } onChange={ ({ target }) => setCurrentPassword( target.value ) } />
              <input type="password" placeholder='New Password' value={ newPassword } onChange={ ({ target }) => setNewPassword( target.value ) } />
              <input type="password" placeholder='Confirm New Password' value={ confirmNewPassword } onChange={ ({ target }) => setConfirmNewPassword( target.value ) } />
